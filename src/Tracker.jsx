...
const Tracker = () => {
   ...
   useEffect(() => {
      const url = `https://api.edamam.com/api/nutrition-data?app_id=${app_id}&app_key=${app_key}&ingr=${searchItem.amount}%20${searchItem.size}%20${searchItem.foodText}`;
      fetch(url)
